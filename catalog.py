...
#
# Етап 3.
# З використаннм бази даних користувач буде мати можливість не тільки додавата якісь нові продукти, а також їх видаляти, змінювати кількість чи параметри (вагу, ціну тощо)
# Головним ідентифікатором виступатиме наш унікальний ключ, яки тепер також буде створюватися користувачем.
# ВІдповідно флов роботи з кастомером буде виглядати наступним чином:
# Ввід ідентифікатора ->  якщо немає в базі -> його свторення і занесення посаткових параметрів
#                     -> якщо є -> його редагування чи видалення.
# Результат роботи залишається незмінним.
#
###########################
# Рішення нижче
###########################
